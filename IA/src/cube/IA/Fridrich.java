...
public class Fridrich {
	...
	public void F2L() {
		if(Integer.parseInt(String.valueOf(m.getPos(4, 3).charAt(m.getPos(4, 3).length()-1))) == 3 && 
				Integer.parseInt(String.valueOf(m.getPos(4, 4).charAt(m.getPos(4, 3).length()-1))) == 3 && 
				Integer.parseInt(String.valueOf(m.getPos(4, 6).charAt(m.getPos(4, 3).length()-1))) == 3 && 
				Integer.parseInt(String.valueOf(m.getPos(4, 7).charAt(m.getPos(4, 3).length()-1))) == 3 && 
				Integer.parseInt(String.valueOf(m.getPos(4, 8).charAt(m.getPos(4, 3).length()-1))) == 3 &&
				...
				Integer.parseInt(String.valueOf(m.getPos(3, 4).charAt(m.getPos(3, 3).length()-1))) == 5 && 
				Integer.parseInt(String.valueOf(m.getPos(3, 5).charAt(m.getPos(3, 3).length()-1))) == 5 && 
				Integer.parseInt(String.valueOf(m.getPos(3, 6).charAt(m.getPos(3, 3).length()-1))) == 5 && 
				Integer.parseInt(String.valueOf(m.getPos(3, 7).charAt(m.getPos(3, 3).length()-1))) == 5 && 
				Integer.parseInt(String.valueOf(m.getPos(3, 8).charAt(m.getPos(3, 3).length()-1))) == 5 
				) {
